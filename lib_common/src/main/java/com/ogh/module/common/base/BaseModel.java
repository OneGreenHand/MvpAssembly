...
import com.ogh.module.common.bean.FileInfoBean;
import com.ogh.module.common.config.AppConfig;
import com.ogh.module.common.request.APIException;
import com.ogh.module.common.request.HttpRequest;
import com.ogh.module.common.util.GsonUtil;
...
public class BaseModel {
    ...
    private <B extends BaseBean> Observer<ResponseBody> getResponseBodySubscriber(final String tag, final Class<B> clazz) {
        ...
        if (!NetworkUtils.isWifiConnected() && !NetworkUtils.isConnected()) {
            ...
            ToastUtil.showCenterToast(CommonUtil.getContext(), "请检查您的网络！");
            return null;
        }
